...
<head>
    ...
    <script type="text/javascript">
        var UPPSITE_ROOT_URL = "<?php echo get_bloginfo("template_url"); ?>/";
        var UPPSITE_BLOG_URL = "<?php bloginfo("url"); ?>/";
        var UPPSITE_BLOG_NAME = "<?php bloginfo("name")?>";
        var UPPSITE_ADS = <?php echo mysiteapp_get_ads(); ?>;
        var UPPSITE_PLUGIN_VERSION = "<?php echo mysiteapp_get_plugin_version(); ?>";
        var UPPSITE_ANALYTICS_KEY = "<?php echo uppsite_get_analytics_key(); ?>";
        var UPPSITE_APP_ID = "<?php echo uppsite_get_appid() ?>";
        var WINDOW_HEIGHT = window.inneHeight;
        var WINDOW_WIDTH = window.innerWidth;
        var PHP_USER_AGENT = "<?php echo array_key_exists("HTTP_USER_AGENT", $_SERVER) ? $_SERVER['HTTP_USER_AGENT'] : "" ?>";
    </script>
